...
public class DateTest {
    ...
    public DateTest() {
        ...
        preferences.add("Day");
        DATE.setPreferences(preferences);
    }
    ...
    /**
     * Test of testAge method, of class Date.
     */
    @Test
    public void testAge() {
        assertEquals("Over 18!",DATE.checkAge());
        DATE.setOver18(false);
        assertEquals("Under 18!", DATE.checkAge());
    }
